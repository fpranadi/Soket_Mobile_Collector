...
public class MutasiSimpananBulananConfirmationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mutasi_simpanan_bulanan_confirmation);
        ...
        TabID1=findViewById(R.id.autoCompleteTextViewMutasiSimpananBulanan) ;
        ...
        TabIDMask= currPreference.getIDMaskSimpananBulanan(this);
        ...
        if (currLoggedInStatus)
        {
            ...
            String setText="Mutasi Simpanan Bulanan";
            headerMutasiTabungan.setText(setText);

            IsUsingAutoCompleteID_SimpananBulanan = currPreference.getIsUsingAutoCompleteID(this);
            if (IsUsingAutoCompleteID_SimpananBulanan)
            {
    ...
    private void getAccountInformation()  {
        try {
            ...
            postparams.put("hashCode", clsGenerateSHA.hex256(institutionCode.concat("sipokok").concat(TabID.getText().toString()).concat(hashKey),true));
            sendPostForValidateLogin(urlAPI.concat("/inforekening") , postparams);
        } catch (JSONException e) {
            Toast.makeText(MutasiSimpananBulananConfirmationActivity.this,e.toString() , Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void sendPostForValidateLogin(String url, JSONObject JSONBodyParam)  {
        try{
            ...
            JsonObjectRequest objectRequest=new JsonObjectRequest(Request.Method.POST, url, JSONBodyParam,
                    response -> {
                        ...
                        try {
                            ...
                            if (ResponseCode.equalsIgnoreCase("00")) {
                                ...
                                {
                                    Toast.makeText(MutasiSimpananBulananConfirmationActivity.this,"Data Simpanan Bulanan tidak ada !!!", Toast.LENGTH_LONG).show();
                                }
                            } else {
                    ...
                    error -> Toast.makeText(MutasiSimpananBulananConfirmationActivity.this,error.toString() , Toast.LENGTH_LONG).show()
            )
            {
                @Override
    ...
    private void getNasabah()  {
        try {
            ...
            postparams.put("jenis", "sipokok");
            //clsGenerateSHA hash256 = new clsGenerateSHA();
            postparams.put("hashCode", clsGenerateSHA.hex256(institutionCode.concat("sipokok").concat(hashKey),true));
