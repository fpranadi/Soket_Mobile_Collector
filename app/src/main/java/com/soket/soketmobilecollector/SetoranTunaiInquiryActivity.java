...
public class SetoranTunaiInquiryActivity extends AppCompatActivity  {
    ...
    private boolean IsUsingAutoCompleteID_Setoran;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setoran_tunai_inquiry);

        TextView headerMutasiTabungan =  findViewById(R.id.txtHeaderMutasiSimpBulanan);
        ImageButton btnBack =  findViewById(R.id.imageButtonBackInquirySetoranTunai);
        ImageButton btnNext =  findViewById(R.id.imageButtonNextInquirySetoranTunai);
        TabID =  findViewById(R.id.editTextTabIDSetoranTunai);
        TabID1=findViewById(R.id.autoCompleteTextViewIDSetoranTunai) ;
        ...
        if (currLoggedInStatus)
        {
            ...
            String setText = "Setoran Tunai";
            headerMutasiTabungan.setText(setText);

            IsUsingAutoCompleteID_Setoran = currPreference.getIsUsingAutoCompleteID(this);
            if (IsUsingAutoCompleteID_Setoran)
            {
        ...
        btnScanBarcode.setOnClickListener(view -> {
            IntentIntegrator intentIntegrator = new IntentIntegrator(SetoranTunaiInquiryActivity.this);
        ...
        btnNext.setOnClickListener(view -> {
            dialog = ProgressDialog.show(SetoranTunaiInquiryActivity.this, "Syncing","Please wait...", true);
    ...
    private void sendPostForValidateTabID(String url, JSONObject JSONBodyParam)  {
        try{
            ...
            JsonObjectRequest objectRequest=new JsonObjectRequest(Request.Method.POST, url, JSONBodyParam,
                    response -> {
                        ...
                        try {
                            ...
                            if (ResponseCode.equalsIgnoreCase("00")) {
                                ...
                                {
                                    Toast.makeText(SetoranTunaiInquiryActivity.this,"Data Tabungan tidak ada !!!", Toast.LENGTH_LONG).show();
                                }
                    ...
                    error -> {
                        dialog.dismiss();
                        Toast.makeText(SetoranTunaiInquiryActivity.this,error.toString() , Toast.LENGTH_LONG).show();
                    }
            )
            {
                @Override
