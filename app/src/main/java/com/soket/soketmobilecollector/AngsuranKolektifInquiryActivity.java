...
public class AngsuranKolektifInquiryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_angsuran_kolektif_inquiry);
        ...
        TextView headerMutasiTabungan =  findViewById(R.id.txtHeaderAngsuranKolektif);
        ImageButton btnBack =  findViewById(R.id.imageButtonBackInquiryAngsuranKolektif);
        ImageButton btnNext =  findViewById(R.id.imageButtonNextInquiryAngsuranKolektif);
        TabID =  findViewById(R.id.editTextTabIDAngsuranKolektif);
        ...
        if (currLoggedInStatus)
        {
            ...
            String setText=getString(R.string.AngsuranKolektif);
        ...
        btnScanBarcode.setOnClickListener(view -> {
            IntentIntegrator intentIntegrator = new IntentIntegrator(AngsuranKolektifInquiryActivity.this);
        ...
        btnNext.setOnClickListener(view -> {
            dialog = ProgressDialog.show(AngsuranKolektifInquiryActivity.this, "Syncing","Please wait...", true);
    ...
    private void getAccountInformation()  {
        try {
            ...
            postparams.put("jenis", "tabungan_listedautodebet");
    ...
    private void sendPostForValidateTabID(String url, JSONObject JSONBodyParam)  {
        try{
            ...
            JsonObjectRequest objectRequest=new JsonObjectRequest(Request.Method.POST, url, JSONBodyParam,
                        ...
                        try {
                            ...
                            if (ResponseCode.equalsIgnoreCase("00")) {
                                ...
                                if (Accounts.length()> 0)
                                {
                                    ...
                                    Intent intent = new Intent(AngsuranKolektifInquiryActivity.this, AngsuranKolektifActivity.class);
                                ...
                                {
                                    Toast.makeText(AngsuranKolektifInquiryActivity.this,"Data Tabungan tidak ada atau tidak terdaftar di Program Auto Debet !!!", Toast.LENGTH_LONG).show();
                                }
                            } else {
                    ...
                    error -> {
                        dialog.dismiss();
                        Toast.makeText(AngsuranKolektifInquiryActivity.this,error.toString() , Toast.LENGTH_LONG).show();
                    }
            )
            {
                @Override
    ...
    private void getNasabah()  {
        try {
            ...
            postparams.put("InstitutionCode", institutionCode);
            postparams.put("jenis", "tabungan_listedautodebet");
            postparams.put("hashCode", clsGenerateSHA.hex256(institutionCode.concat("tabungan_listedautodebet").concat(hashKey),true));
    ...
    private void sendPostForGetNasabah(String url, JSONObject JSONBodyParam)  {
        try{
            ...
            JsonObjectRequest objectRequest=new JsonObjectRequest(Request.Method.POST, url, JSONBodyParam,
                    ...
                    error -> Toast.makeText(AngsuranKolektifInquiryActivity.this,error.toString() , Toast.LENGTH_LONG).show()
            )
            {
                @Override
                public Map<String, String> getHeaders() {
